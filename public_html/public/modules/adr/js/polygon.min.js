...
function Info(polygon,map){
	...
	$(this.button).val(s_message["assign_claims"]);
	this.buttonUnassigned=document.createElement('input');
	$(this.buttonUnassigned).attr('type','button');
	$(this.buttonUnassigned).val(s_message["unassigned_claims"]);
	var thisOjb=this;
	this.assignClaims=function(){
	...
	this.getContent=function(){
		...
		$(this.button).click(function(){
			thisOjb.assignClaims();
		});
		$(content).append(this.color);
		$(content).append(this.button);
		$(content).append(this.buttonUnassigned);
		return content;
	};
	thisObj=this;
